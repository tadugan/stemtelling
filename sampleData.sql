-- To populate the STEMtelling database with sample data, create the accounts listed below and run the queries
...
-- Step 5: run the following queries to create student stemtells
...
-- Step 6: run the following queries to add tags to the stemtells via the stemtell_tag table
...
-- Step 7: run the following queries to add comments to the comment table
...
-- Step 8: existing stemtell reactions
